  ...
  return (
    <div className="w-full px-3 md:px-10 mb-9">
        <div className="w-full  flex flex-col mb-4 "> 
            ...
            <p className="text-lg md:text-xl font-normal leading-7 mt-2 text-left" >Get to shop all the latest release of iphone series, that drops at a much lower price and safe delivery</p>
        </div>
